      ...
      <div className="p-8">
        ...
        <div className="mb-6">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h4 className="text-green-600 font-bold font-poppins">{product.curriculum.title}</h4>
          </div>
        ...
        <div className="mb-6">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h4 className="text-green-600 font-bold font-poppins">{product.features.title}</h4>
          </div>
          <ul className="space-y-2">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h4 className="text-purple-600 font-bold font-poppins">{product.additionalFeatures.title}</h4>
          </div>
